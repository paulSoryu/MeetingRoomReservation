...
namespace MeetingRoomReservation.Infrastructure.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // The single source of truth for "is this slot taken": EF's model-based HasIndex
            // can't span a property on the owner (ResourceId) and one on an owned type mapped
            // to the same table (TimeSlot.SlotStart), so this is added directly by column name.
            // Any future migration touching this table must carry this index forward.
            migrationBuilder.CreateIndex(
